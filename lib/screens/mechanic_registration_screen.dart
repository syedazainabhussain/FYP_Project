...
class _MechanicRegistrationScreenState
  ...
  // ================= IMAGE PICK =================
  Future<void> pickImage(bool isCnic) async {
    final XFile? img =
        await _picker.pickImage(source: ImageSource.gallery);
    if (img != null) {
      setState(() {
        isCnic ? cnicImage = File(img.path) : profileImage = File(img.path);
      });
    }
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          input('Password',
              isPassword: true, onChanged: (v) => password = v),
        ...
        children: [
          DropdownButtonFormField(
            ...
            items: const [
              DropdownMenuItem(
                  value: 'Bike Mechanic',
                  child: Text('Bike Mechanic')),
              DropdownMenuItem(
                  value: 'Car Mechanic',
                  child: Text('Car Mechanic')),
              DropdownMenuItem(
                  value: 'Puncture Specialist',
                  child: Text('Puncture Specialist')),
            ],
