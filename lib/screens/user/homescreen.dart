...
class _HomeScreenState extends State<HomeScreen> {
  ...
  File? _profileImage; // Add this variable to store the selected profile image
            ...
            nearbyMechanics = List<Map<String, dynamic>>.from(
              (data['mechanics'] as List).map(
                (m) => {
                  "id":
                      m['id'] ??
                      0, // ID might not be in the DTO, check if needed or use index/random
          ...
          children: [
            DrawerHeader(
              ...
              child: Column(
                children: [
                  GestureDetector(
                    // Wrap CircleAvatar in GestureDetector to make it tappable
          ...
          child: Container(
            ...
            child: const Icon(Icons.add, color: Colors.white, size: 20),
                  ...
                  Text(
                    ...
                    style: GoogleFonts.poppins(
                      color: const Color.fromARGB(179, 15, 12, 12),
                      fontSize: 13,
                    ),
                  ),
                ],
            ...
            _drawerItem(Icons.safety_check_rounded, "Safety", context),
